...
export default function ResetPassword() {
  ...
  return (
        <div className=" w-full bg-slate-800 flex items-center justify-center min-h-[100vh]">
        {/* forget password card */}
        <form className="flex flex-col border-2 border-blue-500 justify-center gap-6 rounded-lg p-4 text-white w-80 h-[22rem] shadow-[0_0_10px_black]"
